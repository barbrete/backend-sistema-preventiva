...
const criarFoto = async (req, res) => {
    ...
    try {
        ...
        const foto = await fotoService.createFoto(file, tipo, parseInt(preventiva_id), parseInt(userId), usuario.tipo);
...
const atualizarFoto = async (req, res) => {
    ...
    try {
        ...
        const foto = await fotoService.updateFoto(id, file, parseInt(userId), usuario.tipo, parseInt(preventiva_id), tipo);
